...
public class ClienteTelepeaje {
    ...
    private List<ModuloGestionClientes.Dominio.Vehiculo> vehiculosCliente;
    ...
    public ClienteTelepeaje(String nombre, String ci, String email, List<ModuloGestionClientes.Dominio.Vehiculo> vehiculosCliente) {
        this.nombre = nombre;
        this.ci = ci;
        this.email = email;
